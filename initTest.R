####################################################################################################
####################################################################################################
###### Preparation of input files for regeneration model
...
inputDir <- "../rf/bon/pourDC_nouveau/geoInfo"
####################################################################################################
...
### fetching forest inventory
forestInventory <- readOGR(dsn = "../gis", layer = "forestInventory")
#forestInventory2 <- readOGR(dsn = "../gis", layer = "PEE_ORI_IQS_ZoneEtude")

# defining projection (Quebec Lambert NAD83), and reprojecting for study area
